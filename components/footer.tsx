          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3 font-mulish">
                <li>
                  <Link href="/" className="flex items-center text-white/90 hover:text-primary transition-colors">
                ...
                <li>
                  <Link
                    href="/quienes-somos"
                    className="flex items-center text-white/90 hover:text-primary transition-colors"
                  >
                    <ChevronRight className="w-4 h-4 mr-2 text-primary" />
                    Quienes Somos
                  </Link>
            ...
            <div>
              ...
              <form className="flex flex-col space-y-3">
                <input
                  ...
                  className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary text-white placeholder:text-white/60 font-mulish"
                />
                <button
                  type="submit"
                  className="bg-primary text-white font-maven font-semibold py-3 px-4 rounded-lg hover:bg-primary-dark transition-colors"
                >
                  Suscribirse
                </button>
              </form>
